...
contains
    ...
    subroutine GEOMAT(n, COMPI, RAIOI, ESPHI, MEY, MI, RO, RESISTI, INDUCTI, COMPLII)
        ...
        do m = 1, n
            ...
            print '(A,ES14.6)', "    COMPLIIancia:  ", COMPLII(m)
            print *, ""
        end do
    ...
    subroutine FORMAB(n, A, b, RESISTI, INDUCTI, COMPLII)
        ...
        A(29,30) = 1/COMPLII(15)
        A(30,29) = 1/INDUCTI(15)
        A(30,30) = -RESISTI(15)/INDUCTI(15)
        A(31,32) = 1/COMPLII(16)
        A(31,34) = -1/COMPLII(16)
        A(31,36) = -1/COMPLII(16)
        A(32,27) = 1/INDUCTI(16)
        A(32,31) = -1/INDUCTI(16)
        A(32,34) = -RESISTI(16)/INDUCTI(16)
        A(32,36) = -RESISTI(16)/INDUCTI(16)
        A(33,34) = 1/COMPLII(17)
        A(34,33) = 1/INDUCTI(17)
        A(34,34) = -RESISTI(17)/INDUCTI(17)
        A(35,36) = 1/COMPLII(18)
        A(36,35) = 1/INDUCTI(18)
        A(36,36) = -RESISTI(18)/INDUCTI(18)
        A(37,38) = 1/COMPLII(19)
        A(38,37) = 1/INDUCTI(19)
        A(38,38) = -RESISTI(19)/INDUCTI(19)
        A(39,40) = 1/COMPLII(20)
        A(40,39) = 1/INDUCTI(20)
        A(40,40) = -RESISTI(20)/INDUCTI(20)
        A(41,42) = 1/COMPLII(21)
        A(41,50) = -1/COMPLII(21)
        A(41,52) = -1/COMPLII(21)
        A(42,17) = 1/INDUCTI(21)
        A(42,41) = -1/INDUCTI(21)
        A(42,50) = -RESISTI(21)/INDUCTI(21)
        A(42,52) = -RESISTI(21)/INDUCTI(21)
        A(43,44) = 1/COMPLII(22)
        A(43,46) = -1/COMPLII(22)
        A(43,48) = -1/COMPLII(22)
        A(44,17) = 1/INDUCTI(22)
        A(44,43) = -1/INDUCTI(22)
        A(44,46) = -RESISTI(22)/INDUCTI(22)
        A(44,48) = -RESISTI(22)/INDUCTI(22)
        A(45,46) = 1/COMPLII(23)
        A(46,45) = 1/INDUCTI(23)
        A(46,46) = -RESISTI(23/INDUCTI(23)
        A(47,48) = 1/COMPLII(24)
        A(48,47) = 1/INDUCTI(24)
        A(48,48) = -RESISTI(24)/INDUCTI(24)
        A(49,50) = 1/COMPLII(25)
        A(49,68) = -1/COMPLII(25)
        A(49,66) = -1/COMPLII(25)
        A(50,41) = 1/INDUCTI(25)
        A(50,49) = -1/INDUCTI(25
        A(50,66) = -RESISTI(25)/INDUCTI(25)
        A(50,68) = -RESISTI(25)/INDUCTI(25)
        A(51,52) = 1/COMPLII(26)
        A(51,54) = -1/COMPLII(26)
        A(51,56) = -1/COMPLII(26)
        A(52,48) = 1/INDUCTI(26)
        A(52,51) = -1/INDUCTI(26)
        A(52,54) = -RESISTI(26)/INDUCTI(26)
        A(52,56) = -RESISTI(26)/INDUCTI(26)
        A(53,54) = 1/COMPLII(27)
        A(54,53) = 1/INDUCTI(27)
        A(54,54) = -RESISTI(27)/INDUCTI(27)
        A(55,56) = 1/COMPLII(28)
        A(55,58) = -1/COMPLII(28)
        A(55,60) = -1/COMPLII(28)
        A(56,51) = 1/INDUCTI(28)
        A(56,55) = -1/INDUCTI(28)
        A(56,58) = -RESISTI(28)/INDUCTI(28)
        A(56,60) = -RESISTI(28)/INDUCTI(28)
        A(57,58) = 1/COMPLII(29)
        A(58,57) = 1/INDUCTI(29)
        A(58,58) = -RESISTI(29)/INDUCTI(29)
        A(59,60) = 1/COMPLII(30)
        A(59,62) = -1/COMPLII(30)
        A(59,64) = -1/COMPLII(30)
        A(60,55) = 1/INDUCTI(30)
        A(60,69) = -1/INDUCTI(30)
        A(60,62) = -RESISTI(30)/INDUCTI(30)
        A(60,64) = -RESISTI(30)/INDUCTI(30)
        A(61,62) = 1/COMPLII(31)
        A(62,61) = 1/INDUCTI(31)
        A(62,62) = -RESISTI(31)/INDUCTI(31)
        A(63,64) = 1/COMPLII(32)
        A(64,63) = 1/INDUCTI(32)
        A(64,64) = -RESISTI(32)/INDUCTI(32)
        A(65,66) = 1/COMPLII(33)
        A(66,65) = 1/INDUCTI(33)
        A(66,66) = -RESISTI(33)/INDUCTI(33)
        A(67,68) = 1/COMPLII(34)
        A(67,70) = -1/COMPLII(34)
        A(67,72) = -1/COMPLII(34)
        A(68,49) = 1/INDUCTI(34)
        A(68,67) = -1/INDUCTI(34)
        A(68,70) = -RESISTI(34)/INTUCTI(34)
        A(68,72) = -RESISTI(34)/INDUCTI(34)
        A(69,70) = 1/COMPLII(35)
        A(69,80) = -1/COMPLII(35)
        A(69,82) = -1/COMPLII(35)
        A(70,67) = 1/INDUCTI(35)
        A(70,69) = -1/INDUCTI(35)
        A(70,80) = -RESISTI(35)/INDUCTI(35)
        A(70,82) = -RESISTI(35)/INDUCTI(35)
        A(71,72) = 1/COMPLII(36)
        A(71,74) = -1/COMPLII(36)
        A(71,76) = -1/COMPLII(36)
        A(71,78) = -1/COMPLII(36)
        A(72,67) = 1/INDUCTI(36)
        A(72,71) = -1/INDUCTI(36)
        A(72,74) = -RESISTI(36)/INDUCTI(36)
        A(72,76) = -RESISTI(36)/INDUCTI(36)
        A(72,78) = -RESISTI(36)/INDUCTI(36)
        A(73,74) = 1/COMPLII(37)
        A(74,73) = 1/INDUCTI(37)
        A(74,74) = -RESISTI(37)/INDUCTI(37)
        A(75,76) = 1/COMPLII(38)
        A(76,75) = 1/INDUCTI(38)
        A(76,76) = -RESISTI(38)/INDUCTI(38)
        A(77,78) = 1/COMPLII(39)
        A(78,77) = 1/INDUCTI(39)
        A(78,78) = -RESISTI(39)/INDUCTI(39)
        A(79,80) = 1/COMPLII(40)
        A(80,79) = 1/INDUCTI(40)
        A(80,80) = -RESISTI(40)/INDUCTI(40)
        A(81,82) = 1/COMPLII(41)
        A(81,84) = -1/COMPLII(41)
        A(81,86) = -1/COMPLII(41)
        A(82,69) = 1/INDUCTI(41)
        A(82,81) = -1/INDUCTI(41)
        A(82,84) = -RESISTI(41)/INDUCTI(41)
        A(82,86) = -RESISTI(41)/INDUCTI(41)
        A(83,84) = 1/COMPLII(42)
        A(84,83) = 1/INDUCCTI(42)
        A(84,84) = -RESISTI(42)/INDUCTI(42)
        A(85,85) = 1/COMPLII(43)
        A(85,88) = -1/COMPLII(43)
        A(85,90) = -1/COMPLII(43)
        A(86,81) = 1/INDUCTI(43)
        A(86,85) = -1/INDUCTI(43)
        A(86,88) = -RESISTI(43)/INDUCTI(43)
        A(80,90) = -RESISTI(43)/INDUCTI(43)
        A(87,88) = 1/COMPLII(44)
        A(88,87) = 1/INDUCTI(44)
        A(88,88) = -RESISTI(44)/INDUCTI(44)
        A(89,90) = 1/COMPLII(45)
        A(89,92) = -1/COMPLII(45)
        A(89,94) = -1/COMPLII(45)
        A(90,85) = 1/INDUCTI(45)
